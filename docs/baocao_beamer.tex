...
%  Template: HUST - Đại học Bách khoa Hà Nội (Unofficial)
%  Tối ưu compile time cho Overleaf Free Plan
% ============================================================================
...
\setbeamercolor{normal text}{fg=hustblack, bg=hustwhite}
\setbeamercolor{alerted text}{fg=hustred}
\setbeamercolor{example text}{fg=hustgreen}
\setbeamercolor{frametitle}{fg=hustwhite, bg=hustred}
\setbeamercolor{block title}{bg=hustred, fg=hustwhite}
\setbeamercolor{block body}{bg=hustlightgray, fg=hustblack}
\setbeamercolor{block title alerted}{bg=hustreddark, fg=hustwhite}
\setbeamercolor{block body alerted}{bg=hustlightgray, fg=hustblack}
\setbeamercolor{block title example}{bg=hustgreen, fg=hustwhite}
\setbeamercolor{block body example}{bg=hustlightgray, fg=hustblack}
\setbeamercolor{item}{fg=hustred}
\setbeamercolor{subitem}{fg=hustredlight}
\setbeamercolor{subsubitem}{fg=hustyellow}
\setbeamercolor{section in toc}{fg=hustred}

% Itemize markers
\setbeamertemplate{itemize item}{\color{hustred}\scriptsize$\blacksquare$}
\setbeamertemplate{itemize subitem}{\color{hustredlight}\scriptsize$\blacktriangleright$}
\setbeamertemplate{itemize subsubitem}{\color{hustyellow}\scriptsize$\diamond$}
\setbeamertemplate{section in toc}[square]
\setbeamertemplate{navigation symbols}{}

% ============================================================================
%  FRAMETITLE (No TikZ - uses \rule for yellow stripe)
% ============================================================================
\setbeamertemplate{frametitle}{%
  \nointerlineskip%
  \begin{beamercolorbox}[wd=\paperwidth, ht=2.8ex, dp=1.2ex, leftskip=1.2em, rightskip=1.2em]{frametitle}%
    \usebeamerfont{frametitle}\insertframetitle%
    \hfill%
    {\scriptsize\color{hustyellow}\insertframesubtitle}%
  \end{beamercolorbox}%
  \nointerlineskip%
  {\color{hustyellow}\rule{\paperwidth}{0.08cm}}%
  \vspace{0.08cm}%
}

% ============================================================================
%  FOOTLINE (No TikZ - uses \rule for yellow stripe)
% ============================================================================
\setbeamertemplate{footline}{%
  \leavevmode%
  {\color{hustyellow}\rule{\paperwidth}{0.06cm}}%
  \hbox{%
    \begin{beamercolorbox}[wd=.3\paperwidth, ht=2.5ex, dp=1.1ex, leftskip=1em]{author in head/foot}%
      {\tiny\color{hustgray}\insertshortauthor}%
    \end{beamercolorbox}%
    \begin{beamercolorbox}[wd=.4\paperwidth, ht=2.5ex, dp=1.1ex, center]{title in head/foot}%
      {\tiny\color{hustgray}\insertshorttitle}%
    \end{beamercolorbox}%
    \begin{beamercolorbox}[wd=.3\paperwidth, ht=2.5ex, dp=1.1ex, rightskip=1em]{date in head/foot}%
      \hfill{\tiny\color{hustred}\textbf{\insertframenumber\,/\,\inserttotalframenumber}}%
    \end{beamercolorbox}%
  }%
  \vskip0pt%
}
...
%  THÔNG TIN BÌA
% ============================================================================
\title[AZ Tank Game -- AI]{Huấn Luyện AI Xe Tăng Đối Kháng}
\author[Nhóm SV -- HUST]{Phạm Đỗ Đức Dương \and Cao Thanh Hùng}
\institute[HUST]{Đại học Bách khoa Hà Nội}
\date{\today}
...
% --- Slide 1: Trang bìa HUST ---
\begin{frame}[plain, noframenumbering]
  \begin{tikzpicture}[remember picture, overlay]
    % Header đỏ
    \fill[hustred] (current page.north west) rectangle ([yshift=-1.5cm]current page.north east);
    \fill[hustyellow] ([yshift=-1.5cm]current page.north west) rectangle ([yshift=-1.68cm]current page.north east);
    % Tên trường
    \node[text=hustwhite, font=\fontsize{10pt}{12pt}\selectfont\bfseries] at ([yshift=-0.45cm]current page.north) {ĐẠI HỌC BÁCH KHOA HÀ NỘI};
    \node[text=hustyellowlight, font=\fontsize{7pt}{9pt}\selectfont] at ([yshift=-0.9cm]current page.north) {HANOI UNIVERSITY OF SCIENCE AND TECHNOLOGY};
    % Footer đỏ
    \fill[hustred] (current page.south west) rectangle ([yshift=0.55cm]current page.south east);
    \fill[hustyellow] ([yshift=0.55cm]current page.south west) rectangle ([yshift=0.7cm]current page.south east);
    \node[text=hustwhite, font=\fontsize{5pt}{6pt}\selectfont] at ([yshift=0.2cm]current page.south) {SỐ 1 ĐẠI CỒ VIỆT, HAI BÀ TRƯNG, HÀ NỘI};
  \end{tikzpicture}

  \vspace{1.2cm}
  \begin{center}
    {\color{hustgray}\textit{Môn học: IT3160 -- Giới thiệu Trí tuệ nhân tạo}}

    \vspace{0.2cm}
    {\color{hustred}\rule{0.7\paperwidth}{1.2pt}}\\
    {\color{hustyellow}\rule{0.5\paperwidth}{0.6pt}}

    \vspace{0.4cm}
    {\color{hustred}\LARGE\bfseries \faGamepad~Huấn Luyện AI Xe Tăng Đối Kháng}

    \vspace{0.2cm}
    {\color{hustblack}\large Bằng Phương Pháp Học Tăng Cường (PPO)\\trong game đối kháng AZ Tank 2D}

    \vspace{0.3cm}
    {\color{hustyellow}\rule{0.4\paperwidth}{0.6pt}}

    \vspace{0.3cm}
    {\color{hustblack}\small\textbf{Nhóm sinh viên thực hiện:}\\[3pt]
    Phạm Đỗ Đức Dương (202416466) \quad$\bullet$\quad Cao Thanh Hùng (202416502)}

    \vspace{0.3cm}
    {\color{hustgray}\small\textbf{Giảng viên hướng dẫn:} PGS.TS Lê Thanh Hương}

    \vspace{0.3cm}
    {\color{hustgray}\small \today}
  \end{center}
\end{frame}
...
\begin{frame}{Cấu trúc bài thuyết trình}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{\faListOl~Phần I: Tổng quan và Đặt vấn đề}
        \begin{itemize}
      ...
      \end{block}
      \vspace{0.3em}
      \begin{block}{\faCogs~Phần II: Thiết kế Hệ thống RL}
        \begin{itemize}
    ...
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{block}{\faBrain~Phần III: Cơ sở Thuật toán}
        \begin{itemize}
      ...
      \end{block}
      \vspace{0.3em}
      \begin{block}{\faChartLine~Phần IV \& V: Huấn luyện \& Thực nghiệm}
        \begin{itemize}
...
\begin{frame}{Lý do chọn đề tài}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{\faGamepad~Tính chất trò chơi đối kháng}
        Game đối kháng xe tăng 2D thời gian thực đòi hỏi khả năng ra quyết định tốc độ cao để bắn hạ đối thủ và sinh tồn.
      \end{block}
      \vspace{0.3em}
      \begin{alertblock}{\faExclamationTriangle~Hạn chế của Bot truyền thống}
    ...
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{exampleblock}{\faLightbulb~Giải pháp ứng dụng AI}
...
\begin{frame}{Mục tiêu cốt lõi}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{\faFlask~Giải quyết bài toán học máy}
      ...
      \end{block}
      \vspace{0.3em}
      \begin{block}{\faLink~Tích hợp hệ thống tối ưu}
    ...
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{exampleblock}{\faRocket~Triển khai Release thực tế}
...
\begin{frame}{Môi trường AZ Tank 2D}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{\faCubes~Đặc điểm mô phỏng}
        \begin{itemize}
    ...
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{alertblock}{\faExclamationCircle~Đặc trưng bài toán điều khiển}
        \begin{itemize}
...
\begin{frame}{Kiến trúc tổng thể}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{\faProjectDiagram~Logic -- Renderer Decoupling}
        \small
      ...
      \end{block}
      \vspace{0.3em}
      \begin{exampleblock}{\faCodeBranch~Chia sẻ chung Game Engine}
...
\begin{frame}{Không gian Quan sát (52 chiều)}
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      \begin{block}{\faTable~Chuẩn hóa dữ liệu về $[-1, 1]$}
        \scriptsize
    ...
    \begin{column}{0.46\textwidth}
      \begin{exampleblock}{\faSatelliteDish~Cơ cấu cảm biến}
        \small
        \begin{itemize}
...
\begin{frame}{Không gian Hành động}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{\faKeyboard~MultiDiscrete([3, 3, 2])}
      ...
      \end{block}
      \vspace{0.3em}
      \begin{exampleblock}{\faCheckCircle~Ưu điểm}
...
\begin{frame}{Hệ thống Phần thưởng -- Sparse}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{\faAward~Sparse Rewards (Phần thưởng thưa)}
    ...
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{alertblock}{\faSkullCrossbones~Hình phạt tự sát}
        \begin{itemize}
...
\begin{frame}{Hệ thống Phần thưởng -- Dense}
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      \begin{block}{\faRoute~Dẫn hướng và Bám Waypoint}
        \scriptsize
        \begin{itemize}
      ...
      \end{block}
      \vspace{0.3em}
      \begin{alertblock}{\faBan~Phạt lối chơi thụ động}
        \scriptsize
        \begin{itemize}
    ...
    \end{column}
    \begin{column}{0.46\textwidth}
      \begin{exampleblock}{\faBalanceScale~Hệ số suy giảm $SF$}
        \small
...
\begin{frame}{Mạng nơ-ron MLP Policy}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{\faNetworkWired~Cấu trúc mạng nơ-ron}
...
\begin{frame}{Thuật toán PPO và GAE}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{\faSuperscript~PPO (Actor-Critic)}
...
\begin{frame}{Mô hình hóa không gian đồ thị}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{\faBorderAll~Grid Discretization}
      ...
      \end{block}
      \vspace{0.3em}
      \begin{block}{\faExpandArrowsAlt~C-Space \& Inflation}
...
\begin{frame}{Thuật toán Pathfinding}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{\faMapSigns~Thuật toán A*}
      ...
      \end{block}
      \vspace{0.3em}
      \begin{exampleblock}{\faAngleDoubleRight~Theta* (Any-Angle)}
...
\begin{frame}{Đối thủ Rule-based (Bot C++)}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{\faRobot~Cơ chế đa luồng}
    ...
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{block}{\faCrosshairs~Bắn phản xạ \& Tránh né}
        \begin{itemize}
...
\begin{frame}{Lộ trình Curriculum Learning}
  \begin{columns}[T]
    \begin{column}{0.55\textwidth}
      \begin{block}{\faGraduationCap~11 giai đoạn huấn luyện}
        \centering
        \scriptsize
    ...
    \begin{column}{0.41\textwidth}
      \begin{exampleblock}{\faLayerGroup~Phân tích}
        \small
        \begin{itemize}
...
\begin{frame}{Cơ chế Self-Play}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{\faSync~Đối đầu với chính mình}
    ...
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{block}{\faDatabase~Opponent Pool}
        \begin{itemize}
...
\begin{frame}{Triển khai C++ Inference}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{\faFileExport~Quy trình xuất mô hình}
        \small
        \begin{enumerate}
    ...
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{exampleblock}{\faBolt~Hiệu năng tối đa}
        \small
        \begin{itemize}
...
\begin{frame}{Các hành vi chiến thuật nổi bật}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{\faCompass~Điều hướng \& Né tránh}
        \begin{itemize}
    ...
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{block}{\faCrosshairs~Chiến đấu \& Vật phẩm}
        \begin{itemize}
...
\begin{frame}{Phân tích đường cong hội tụ}
  \begin{columns}[T]
    ...
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{block}{\faChartLine~Chỉ số hội tụ}
        \small
        \begin{itemize}
...
\begin{frame}{Tỉ lệ đối đầu thực tế}
  \begin{columns}[T]
    \begin{column}{0.42\textwidth}
      \begin{block}{\faTrophy~Thống kê (100 trận)}
        \centering
        \scriptsize
        \renewcommand{\arraystretch}{1.1}
...
\begin{frame}{Benchmark Pathfinding}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{\faDatabase~Thống kê (N=300)}
        \centering
        \scriptsize
      ...
      \end{block}
      \vspace{0.2em}
      \begin{exampleblock}{\faSearchPlus~Nhận xét}
        \tiny
        \begin{itemize}
...
\begin{frame}{Kết luận}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{\faCheckCircle~Thành công cốt lõi}
        \begin{itemize}
    ...
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{exampleblock}{\faCogs~Triển khai \& Hiệu suất}
        \begin{itemize}
...
\begin{frame}{Hướng phát triển tương lai}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{\faRocket~Đề xuất cải tiến}
        \begin{itemize}
    ...
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{block}{\faBook~Tài liệu tham khảo}
        \tiny
...
\begin{frame}[plain, noframenumbering]
  ...
  \begin{center}
    ...
    \faEnvelope~duong.pdd202416466@sis.hust.edu.vn \quad$\bullet$\quad
    \faEnvelope~hung.ct202416502@sis.hust.edu.vn}
  \end{center}
\end{frame}
